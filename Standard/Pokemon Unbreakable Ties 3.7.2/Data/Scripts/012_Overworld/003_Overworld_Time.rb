...
module PBDayNight
  ...
  def self.isDay?(time=nil)
    return ($game_variables[123] >=10 && $game_variables[123] < 13)
  end

  # Returns true if it's night.
  def self.isNight?(time=nil)
    return ($game_variables[123] >=21 && $game_variables[123] < 24) || ($game_variables[123] >=0 && $game_variables[123] < 6)
  end

  # Returns true if it's morning.
  def self.isMorning?(time=nil)
    return ($game_variables[123] >=6 && $game_variables[123] < 10)
  end

  # Returns true if it's the afternoon.
  def self.isAfternoon?(time=nil)
    return ($game_variables[123] >=13 && $game_variables[123] < 18)
  end

  # Returns true if it's the evening.
  def self.isEvening?(time=nil)
    return ($game_variables[123] >=18 && $game_variables[123] < 21)
  end
