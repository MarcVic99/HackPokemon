...
ItemHandlers::CanUseInBattle.copy(:POTION,
   ...
   :SODAPOP,:LEMONADE,:MOOMOOMILK,:COFFEE,:SHELLDERECHO,:LATIOBATIDO,:LATIAGALLETA,:LATIOBATIDO,:LATIAGALLETA,:ZUMOCORPHISH,:ORANBERRY,:SITRUSBERRY,:ENERGYPOWDER,:CAKE,
   :ENERGYROOT,:PIZZA,:ROSQUILLA,:ESPAGUETIS)
...
ItemHandlers::CanUseInBattle.add(:HELADODEVAINILLA,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
  next pbBattleItemCanRaiseStat?(:ATTACK,battler,scene,showMessages)
})

ItemHandlers::CanUseInBattle.add(:HELADODECHOCOLATE,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
  next pbBattleItemCanRaiseStat?(:DEFENSE,battler,scene,showMessages)
})


ItemHandlers::CanUseInBattle.add(:HELADODEMENTA,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
  next pbBattleItemCanRaiseStat?(:SPECIAL_DEFENSE,battler,scene,showMessages)
})


ItemHandlers::CanUseInBattle.add(:HELADODEFRESA,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
  next pbBattleItemCanRaiseStat?(:SPECIAL_ATTACK,battler,scene,showMessages)
})


ItemHandlers::CanUseInBattle.add(:HELADODELIMON,proc { |item,pokemon,battler,move,firstAction,battle,scene,showMessages|
...
ItemHandlers::CanUseInBattle.add(:MAXMUSHROOMS, proc { |item, pokemon, battler, move, firstAction, battle, scene, showMessages|
  ...
  scene.pbDisplay(_INTL("No tendría ningún efecto..")) if showMessages && failed
  next !failed
})
...
ItemHandlers::BattleUseOnPokemon.add(:ZUMOCORPHISH,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(pokemon,battler,100,scene)
})

ItemHandlers::BattleUseOnPokemon.add(:CAKE,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(pokemon,battler,150,scene)
})

ItemHandlers::BattleUseOnPokemon.add(:ROSQUILLA,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(battler,battler,250,scene)
...
ItemHandlers::BattleUseOnPokemon.add(:ESPAGUETIS,proc { |item,pokemon,battler,choices,scene|
  pbBattleHPItem(pokemon,battler,pokemon.totalhp-pokemon.hp,scene)
...
ItemHandlers::BattleUseOnPokemon.add(:PIZZA,proc { |item,pokemon,battler,choices,scene|
  pokemon.heal_status
  battler.pbCureStatus(false) if battler
  battler.pbCureConfusion if battler
  name = (battler) ? battler.pbThis : pokemon.name
...
ItemHandlers::BattleUseOnBattler.add(:CERVEZA,proc { |item,battler,scene|
  pbBattleHPItem(battler,battler,120,scene)
    battler.pbConfuse if battler.pbCanConfuseSelf?(false)
})

ItemHandlers::BattleUseOnBattler.add(:COFFEE,proc { |item,battler,scene|
  pbBattleHPItem(battler,battler,50,scene)
  battler.pbRaiseStatStage(:SPEED,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
})

ItemHandlers::BattleUseOnBattler.add(:LATIAGALLETA,proc { |item,battler,scene|
  pbBattleHPItem(battler,battler,battler.totalhp/3,scene)
  battler.pbRaiseStatStage(:SPECIAL_DEFENSE,2,battler)
})

ItemHandlers::BattleUseOnBattler.add(:LATIOBATIDO,proc { |item,battler,scene|
  pbBattleHPItem(battler,battler,battler.totalhp/3,scene)
  battler.pbRaiseStatStage(:SPECIAL_ATTACK,2,battler)
})

ItemHandlers::BattleUseOnBattler.add(:SHELLDERECHO,proc { |item,battler,scene|
  pbBattleHPItem(battler,battler,battler.totalhp/3,scene)
...
ItemHandlers::BattleUseOnBattler.add(:HELADODEVAINILLA,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:ATTACK,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
  battler.pokemon.changeHappiness("battleitem")
})

ItemHandlers::BattleUseOnBattler.add(:HELADODECHOCOLATE,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:DEFENSE,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
  battler.pokemon.changeHappiness("battleitem")
})

ItemHandlers::BattleUseOnBattler.add(:HELADODEMENTA,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPECIAL_DEFENSE,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
  battler.pokemon.changeHappiness("battleitem")
})

ItemHandlers::BattleUseOnBattler.add(:HELADODEFRESA,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPECIAL_ATTACK,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
  battler.pokemon.changeHappiness("battleitem")
})

ItemHandlers::BattleUseOnBattler.add(:HELADODELIMON,proc { |item,battler,scene|
  battler.pbRaiseStatStage(:SPEED,(Settings::X_STAT_ITEMS_RAISE_BY_TWO_STAGES) ? 2 : 1,battler)
  battler.pokemon.changeHappiness("battleitem")
})
