...
class PokemonEvolutionScene
  ...
  def pbEvolution(cancancel=true)
    ...
    # No permitimos cancelar evo si es el Riolu en el evento
    if (@pokemon.species == :Riolu && $game_switches[426] == false)
      cancancel = false
    end
    ...
    begin
      ...
      Input.update
      pbUpdate(true)
      if Input.trigger?(Input::BACK) && cancancel #&& @pokemon.species != :RIOLU && $game_switches[426] == true
        pbBGMStop
        pbPlayCancelSE
        canceled = true
        break
