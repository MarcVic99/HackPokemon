...
def pbSlotMachine(difficulty=1)
  if $game_switches[851] == false && $game_switches[861] == false
    pbMessage(_INTL("Parece que necesitas un monedero para poder jugar."))
  elsif $game_switches[851] == true
    pbMessage(_INTL("No deberías jugar con el monedero del chaval..."))
  elsif $game_switches[851] == false && $game_switches[861] == true
    if $Trainer.coins == 0
      pbMessage(_INTL("¡No tienes suficientes fichas para poder jugar!"))
    elsif $Trainer.coins == Settings::MAX_COINS
      pbMessage(_INTL("¡Tu monedero está a reventar!"))
    else
      pbFadeOutIn {
