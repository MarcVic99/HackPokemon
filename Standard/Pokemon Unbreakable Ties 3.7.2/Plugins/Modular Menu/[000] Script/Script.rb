...
@sprites["sprite_menu"]=IconSprite.new(0,0,@viewport)
    ...
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Player1_000")
      @sprites["sprite_menu"].y = 10
end
    if $game_variables[101] == 1
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Player2_000")
      @sprites["sprite_menu"].y = 10
end
    if $game_switches[510] == true
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Darek")
      @sprites["sprite_menu"].y = 10
end
    if $game_switches[610] == true
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Eda")
      @sprites["sprite_menu"].y = 10
end
    if $game_switches[613] == true
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Shayan")
      @sprites["sprite_menu"].y = 10
end
    if $game_switches[873] == true
    @sprites["sprite_menu"].setBitmap("Graphics/Pictures/Detective_past")
      @sprites["sprite_menu"].y = 10
end
    ...
    text = []
#horas
    if $game_variables[123] >= 10
    text.push([_INTL("Time: {1}",$game_variables[123]),20,40,0,Color.new(255,255,255),Color.new(0,0,0,100),true])
    else
    text.push([_INTL("Time: 0{1}",$game_variables[123]),20,40,0,Color.new(255,255,255),Color.new(0,0,0,100),true])
end
#minutos
    if $game_variables[122] >= 10
    text.push([_INTL(": {1}",$game_variables[122]),102,40,0,Color.new(255,255,255),Color.new(0,0,0,100),true])
    else
    text.push([_INTL(": 0{1}",$game_variables[122]),102,40,0,Color.new(255,255,255),Color.new(0,0,0,100),true])
end
