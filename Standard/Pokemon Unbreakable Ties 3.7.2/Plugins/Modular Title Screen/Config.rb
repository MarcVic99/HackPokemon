...
module ModularTitle
  ...
  #-------------------------------------------------------------------------------
    # Electric Nightmare
    #"background11", "logo:bounce", "effect9", "logo:shine", "intro:4"
    ...
    # Ocean Breeze
    #"background11", "intro:1", "logoY:172", "logo:sparkle", "logo:shine", "", "", "effect5_y106", "effect4_y106", "bgm:title_frlg"
    ...
    # Forest Sky (gen 6)
    "background:sun", "intro:6", "effect4", "logoY:172", "effect5", "effect7", "bgm:title_xy"
